...
declare -A file_hash_array=() #creating an empty array

#Function to delete the array storing the hashes of each one of the files in the trashCan folder
...
#populating an associative with with the hash codes of the files in the trashCan folder
#this array is used compare the hashes of the files in the folder at a past time with the hashes of the same files at the current time 
...
#Compare the hashes of the files in the folder at a past time with the hashes of the same files at the current time 
...
#Comparing the files that were in the folder at a past time with the files that are in the folder at the current time
#this checks if files were added to the folder
...
#Comparing the files that were in the folder at a past time with the files that are in the folder at the current time
#this checks if files were deleted from the folder
